 ...
 * @subpackage Threefive_Support/includes
 */
...
class Threefive_Support {
	 ...
	 *
	 * - Threefive_Support_Loader. Orchestrates the hooks of the plugin.
	 * - Threefive_Support_i18n. Defines internationalization functionality.
	 * - Threefive_Support_Admin. Defines all hooks for the dashboard.
	 * - Threefive_Support_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-threefive-support-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-threefive-support-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the Dashboard.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-threefive-support-admin.php';
	 ...
	 *
	 * Uses the Threefive_Support_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Threefive_Support_i18n();
		$plugin_i18n->set_domain( $this->get_threefive_support() );
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Threefive_Support_Admin( $this->get_threefive_support(), $this->get_version() );
	 ...
	 */
	public function get_threefive_support() {
		return $this->threefive_support;
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Threefive_Support_Loader    Orchestrates the hooks of the plugin.
	 */
